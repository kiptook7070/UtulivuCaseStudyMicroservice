...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.authorizeRequests()
				.antMatchers("/api/vi/clinical-officer/**").permitAll()
				.antMatchers("/api/vi/clinical-officer/add/**").permitAll()
				.antMatchers("/api/vi/clinical-officer/get-all**").permitAll()
				.antMatchers("/api/vi/clinical-officer/delete/**").permitAll()
