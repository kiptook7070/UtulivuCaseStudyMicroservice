...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.authorizeRequests()
				.antMatchers("/api/v1/member-data/**").permitAll()
				.antMatchers("/api/v1/member-data/add/**").permitAll()
				.antMatchers("/api/v1/member-data/all**").permitAll()
				.antMatchers("/api/v1/member-data/delete/**").permitAll()
